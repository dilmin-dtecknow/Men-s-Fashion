                            ...
                            if ($color_rs->num_rows == 0) {
                                ...
                                try {
                                    ...
                                    if (isset($_FILES['image1']) && $_FILES['image1']['error'] == 0) {
                                        ...
                                        $image1Path = "webImg/productImages/" . $product_id . "/image1.png";
                                        // Use existing image
                                        $image1Path = $_POST['image1'];
                                    }
                                    ...
                                    if (isset($_FILES['image2']) && $_FILES['image2']['error'] == 0) {
                                        ...
                                        $image2Path = "webImg/productImages/" . $product_id . "/image2.png";
                                        $image2Path = $_POST['image2'];
                                    }
                                    ...
                                    if (isset($_FILES['image3']) && $_FILES['image3']['error'] == 0) {
                                        ...
                                        $image3Path = "webImg/productImages/" . $product_id . "/image3.png";
                                        $image3Path = $_POST['image3'];
                                    }
