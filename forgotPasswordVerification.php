...
<head>
    ...
    <title>Shop | Fogot Password Verification Page</title>
...
<body>
    <section class="my-5 py-5">
        <div class="container text-center mt-3 pt-5" id="log-text">
            <h2 class="form-weight-bolde">Fogot Password Verification</h2>
            <hr class="mx-auto">
        </div>
    ...
    <script src="js/forgotPasswordVerification.js"></script>
</body>
