...
<body class="animsition">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    ...
                                    <div class="filters m-b-45">
                                        <form class="form-header" action="" method="POST">
                                            <input id="search-txt" onkeyup="searchUser();" class="au-input au-input--xl" type="text" name="search"
                                    ...
                                    <div class="table-responsive table-data">
                                        <table class="table">
                                            ...
                                            <tbody id="body" >
                                                <?php $user_rs = Database::search("SELECT * FROM user");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2018 Dilmin. All rights reserved. <a
                                            href="#">Dilmin</a>.</p>
                                </div>
                            </div>
                        </div>
    ...
    <!-- program js -->
     <script src="programjs/manageUser.js"></script>
