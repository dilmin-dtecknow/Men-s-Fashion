      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          datasets: [
            {
              label: "My First dataset",
              data: [totalProducts, totalSellers],
              backgroundColor: [
                '#00b5e9',
                '#fa4251'
              ],
  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          datasets: [{
            data: productCounts,  // Use the dynamic product count
            backgroundColor: [
              "rgba(0, 123, 255, 0.9)", // Blue
              "rgba(255, 99, 132, 0.7)", // Red
              "rgba(54, 162, 235, 0.5)", // Green
          ...
          labels: categories  // Use the dynamic category names
        },
        options: {
          legend: {
            position: 'top',
