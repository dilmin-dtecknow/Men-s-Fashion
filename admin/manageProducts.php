...
<body class="animsition">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Product data
                                    </h3>
                                    <div class="filters m-b-45">
                                        <form class="form-header" action="" method="POST">
                                            <input class="au-input au-input--xl" type="text" name="search"
                                                placeholder="Search Product &amp; Id..." id="searchtext" onkeyup="searchProduct();" />
                                    ...
                                    <div class="table-responsive table-data">
                                        <table class="table table-data2">
                                            ...
                                            <tbody id="body">
                                                <?php $product_rs =  Database::search("SELECT * FROM product");
                                                ...
                                                ?>
                                                    <tr class="tr-shadow">
                                                        ...
                                                        <td>
                                                            Rs.<input min="0" type="number" value="<?php echo $product_row['discount'] ?>" id="discount_<?php echo $product_row['product_id'] ?>">
    ...
    <!-- page js -->
    <script src="programjs/manageProduct.js"></script>
